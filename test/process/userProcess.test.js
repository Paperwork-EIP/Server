...
describe("User process", () => {
    ...
    describe("[INTEGRATION TESTS", () => {
        ...
        describe("[INVALID USER PROCESS TESTS]", () => {
            ...
            test("[UPDATE] is done missing : should not update a user process with a 400 status code", async () => {
                const response = await request(server).post("/userProcess/update").send({
                    user_email: "test@test.com",
                    process_title: "Test",
                    step_id: 1
            ...
            test("[UPDATE] is done empty : should not update a user process with a 400 status code", async () => {
                const response = await request(server).post("/userProcess/update").send({
                    user_email: "test@test.com",
                    process_title: "Test",
                    step_id: 1,
